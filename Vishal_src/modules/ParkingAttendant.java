...
public class ParkingAttendant implements Employee, Serializable {
    ...
    public ParkingAttendant(String name) {
        this.setParkingAttendantID("PA" + String.valueOf(++count));
        this.setName(name);
    ...
    public void handlePayment(Ticket ticket) {
        ...
        payment.processPayment(PaymentMethodStatus.CASH);
